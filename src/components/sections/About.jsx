...
export const About = () => {
    ...
    return <section id="about" className="min-h-screen flex items-center py-20 justify-center">
        <RevealOnScroll>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                ...
                <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 transition-all">
                    ...
                    <div className="space-y-4">
                        <div className="">
                            <h4 className="font-semibold">Software Engineering at ABC Corp (2020-present)</h4>
                            <p>Developed Engineer and maintaned microservices for cloud-based applications.</p>
                        </div>
                        <div className="">
